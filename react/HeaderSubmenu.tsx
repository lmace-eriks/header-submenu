...
const HeaderSubmenu: StorefrontFunctionComponent<HeaderSubmenuProps> = ({ menu, menuTitle, showAllLink, children, noPhotos }) => {
  ...
  const ShowAllLink = () => (
    <div className={styles.showAllLinkContainer}>
      <Link href={showAllLink} className={styles.showAllLink}>Show All {menuTitle} ▶</Link>
    </div>
  )
  ...
  return (<>
    ...
    {showAllLink && !finalMenuActive && <ShowAllLink />}
  </>
  );
}
